...
export const RegisterShell: React.FC<{
  ...
  <div className="min-h-screen bg-[#08080a] text-[#ededed] relative overflow-hidden">
    <div
      aria-hidden="true"
    ...
    <header className="relative max-w-4xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
    ...
    <main className={`relative mx-auto px-4 sm:px-6 pt-8 pb-20 ${width === 'narrow' ? 'max-w-xl' : 'max-w-4xl'}`}>
